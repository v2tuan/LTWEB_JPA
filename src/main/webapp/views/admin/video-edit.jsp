...
<div class="form-container">
  ...
  <form action="${pageContext.request.contextPath}/admin/video/update" method="post" enctype="multipart/form-data">
    ...
    <img id="images" height="150" width="150" src="${imgUrl}" alt="Preview Image" />
    ...
    <div class="input-group">
      <div>
        ...
        <input type="text" id="viewCount" name="viewCount" value="${video.views}">
      </div>
      <div>
    ...
    <div class="radio-group">
      ...
      <label>
        <input type="radio" name="active" value="0" ${video.active!=1?'checked':" "}> Non-active
      </label>
    </div>

    <label>Description:</label>
    <textarea id="description" name="description" rows="4" cols="50" placeholder="Nhập mô tả ở đây">${video.description}</textarea>
